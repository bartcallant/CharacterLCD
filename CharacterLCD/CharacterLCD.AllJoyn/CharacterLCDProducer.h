...
extern PCSTR c_CharacterLCDIntrospectionXml;

ref class CharacterLCDProducer;

public interface class ICharacterLCDProducer
{
    event Windows::Foundation::TypedEventHandler<CharacterLCDProducer^, Windows::Devices::AllJoyn::AllJoynProducerStoppedEventArgs^>^ Stopped;
    event Windows::Foundation::TypedEventHandler<CharacterLCDProducer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;
    event Windows::Foundation::TypedEventHandler<CharacterLCDProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;
    event Windows::Foundation::TypedEventHandler<CharacterLCDProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
};

public ref class CharacterLCDProducer sealed : [Windows::Foundation::Metadata::Default] ICharacterLCDProducer
{
public:
    CharacterLCDProducer(Windows::Devices::AllJoyn::AllJoynBusAttachment^ busAttachment);
    virtual ~CharacterLCDProducer();

    // The implementation of ICharacterLCDService that will handle method calls and property requests.
    property ICharacterLCDService^ Service
    {
        ICharacterLCDService^ get() { return m_serviceInterface; }
        void set(ICharacterLCDService^ value) { m_serviceInterface = value; }
    }

    // Used to send signals or register functions to handle received signals.
    property CharacterLCDSignals^ Signals
    {
        CharacterLCDSignals^ get() { return m_signals; }
    }
    
    // This event will fire whenever this producer is stopped.
    virtual event Windows::Foundation::TypedEventHandler<CharacterLCDProducer^, Windows::Devices::AllJoyn::AllJoynProducerStoppedEventArgs^>^ Stopped;
    
    // This event will fire whenever the producer loses the session that it created.
    virtual event Windows::Foundation::TypedEventHandler<CharacterLCDProducer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;
    
    // This event will fire whenever a member joins the session.
    virtual event Windows::Foundation::TypedEventHandler<CharacterLCDProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;

    // This event will fire whenever a member leaves the session.
    virtual event Windows::Foundation::TypedEventHandler<CharacterLCDProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
...
private:
    static void CallSendHandler(_Inout_ alljoyn_busobject busObject, _In_ alljoyn_message message);
    ...
    CharacterLCDSignals^ m_signals;
    ICharacterLCDService^ m_serviceInterface;
