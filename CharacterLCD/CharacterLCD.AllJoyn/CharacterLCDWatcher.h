...
ref class CharacterLCDWatcher;

public interface class ICharacterLCDWatcher
{
    event Windows::Foundation::TypedEventHandler<CharacterLCDWatcher^, Windows::Devices::AllJoyn::AllJoynServiceInfo^>^ Added;
    event Windows::Foundation::TypedEventHandler<CharacterLCDWatcher^, Windows::Devices::AllJoyn::AllJoynProducerStoppedEventArgs^>^ Stopped;
};

public ref class CharacterLCDWatcher sealed : [Windows::Foundation::Metadata::Default] ICharacterLCDWatcher
{
public:
    CharacterLCDWatcher(Windows::Devices::AllJoyn::AllJoynBusAttachment^ busAttachment);
    virtual ~CharacterLCDWatcher();

    // This event will fire whenever a producer for this service is found.
    virtual event Windows::Foundation::TypedEventHandler<CharacterLCDWatcher^, Windows::Devices::AllJoyn::AllJoynServiceInfo^>^ Added;

    // This event will fire whenever the watcher is stopped.
    virtual event Windows::Foundation::TypedEventHandler<CharacterLCDWatcher^, Windows::Devices::AllJoyn::AllJoynProducerStoppedEventArgs^>^ Stopped;
