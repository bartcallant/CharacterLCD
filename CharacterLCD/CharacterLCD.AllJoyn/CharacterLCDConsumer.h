...
public interface class ICharacterLCDConsumer
{
    event Windows::Foundation::TypedEventHandler<CharacterLCDConsumer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;
    event Windows::Foundation::TypedEventHandler<CharacterLCDConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;
    event Windows::Foundation::TypedEventHandler<CharacterLCDConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
};

public ref class CharacterLCDConsumer sealed  : [Windows::Foundation::Metadata::Default] ICharacterLCDConsumer
{
public:
    CharacterLCDConsumer(Windows::Devices::AllJoyn::AllJoynBusAttachment^ busAttachment);
    virtual ~CharacterLCDConsumer();
    ...
    static Windows::Foundation::IAsyncOperation<CharacterLCDJoinSessionResult^>^ JoinSessionAsync(_In_ Windows::Devices::AllJoyn::AllJoynServiceInfo^ serviceInfo, _Inout_ CharacterLCDWatcher^ watcher);

    // Call the Send method
    Windows::Foundation::IAsyncOperation<CharacterLCDSendResult^>^ SendAsync(_In_ Platform::String^ interface_message);
    ...
    virtual event Windows::Foundation::TypedEventHandler<CharacterLCDConsumer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;

    // This event will fire whenever a member joins the session.
    virtual event Windows::Foundation::TypedEventHandler<CharacterLCDConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;

    // This event will fire whenever a member leaves the session.
    virtual event Windows::Foundation::TypedEventHandler<CharacterLCDConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
