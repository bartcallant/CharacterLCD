...
ref class CharacterLCDSignals;

public interface class ICharacterLCDSignals
{
};

public ref class CharacterLCDSignals sealed : [Windows::Foundation::Metadata::Default] ICharacterLCDSignals
{
public:
internal:
